...
* 16:00--17:00 `r link("Introduction to forensic kinship testing", "Lecture3_kinship.pdf", bold = T, live = F)` (TE)
* 17:00--17:45 `r link("Exercises", "exercises3.pdf", live = F)`
* 17:45--18:00 _Break_
* 18:00--19:00 `r link("Kinship testing with Familias", "Lecture4_familias.pdf", bold = T, live = F)` (TE)
* 19:00--19:45 `r link("Exercises", "exercises4.pdf", live = F)`
* 19:45--20:00 Wrap-up

#### Oct 21: Relatedness inference
* 16:00--17:00 `r link("Realised relatedness: Why are some siblings more alike than others?", "Lecture5_realised.pdf", bold = T, live = F)` (MDV)
* 17:00--17:45 `r link("Exercises", "exercises5.pdf", live = F)`
* 17:45--18:00 _Break_
* 18:00--19:00 `r link("Pedigree reconstruction", "Lecture6_reconstruction.pdf", bold = T, live = F)` (MDV)
* 19:00--19:45 `r link("Exercises", "exercises6.pdf", live = F)`
* 19:45--20:00 Wrap-up

#### Oct 28: Disaster victim identification
* 16:00--17:00 `r link("DNA-based disaster victim identification", "Lecture7_dvi.pdf", bold = T, live = F)` (TE)
* 17:00--17:45 `r link("Exercises", "exercises7.pdf", live = F)`
* 17:45--18:00 _Break_
* 18:00--19:00 `r link("Practical DVI with Diviana", "Lecture8_diviana.pdf", bold = T, live = F)` (MDV)
